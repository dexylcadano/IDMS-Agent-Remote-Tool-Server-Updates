...
Public Class CSystemInformation
    ...
    Public Function GetListSysInfo(ByVal stringIn As String) As Dictionary(Of String, String)
                ...
                For Each prop As PropertyData In pdInfo
                    Try
                        If objMng.Properties(prop.Name).Value <> "" Then
                            'Dim encypted_val As String = encryptor.Encrypt(objMng.Properties(prop.Name).Value)
                            'Dim encypted_prop As String = encryptor.Encrypt(prop.Name)
    ...
    Public Function GetListSysInfo() As Dictionary(Of String, String)
        ...
        'item.Add("Computer Name", encryptor.Encrypt(My.Computer.Name.ToString()))
        item.Add("Computer Name", My.Computer.Name.ToString())
    ...
    Private Function GetOpenPorts(ByVal portNum As Object) As Boolean
        ...
        Try
            If tcp.ConnectAsync("127.0.0.1", portNum).Wait(100) Then
                tcp.Close()
                Return True
            End If
